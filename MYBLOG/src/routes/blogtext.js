...
var md_html_b = require('marked');
var Blog_each = require('../model/blog').Blog;
...
router.post('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var blogName, blog, blog_con;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                blogName = req.body.blogName;
                return [4 /*yield*/, Blog_each(blogName, 3)];
            case 1:
                blog = _a.sent();
                blog_con = md_html_b(blog.blogContent);
