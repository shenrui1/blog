...
var Blog_search = require('../model/blog').Blog;
var sear_classtable = require('../model/class').Class;
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                return [4 /*yield*/, Blog_search(blogName.trim(), 3)];
            case 1:
                blog = _d.sent();
                if (blog) {
            ...
            case 3:
                ...
                return [4 /*yield*/, sear_classtable(fin_class[m], 3)];
            case 4:
                re = _d.sent();
                flag = 0;
            ...
            case 7:
                ...
                _c = (_b = blog).push;
                return [4 /*yield*/, Blog_search(blog_name[k].classBlog, 3)];
            case 8:
                _c.apply(_b, [_d.sent()]);
                _d.label = 9;
            case 9:
