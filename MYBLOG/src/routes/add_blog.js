...
var Blog_add = require('../model/blog').Blog;
var add_classtable = require('../model/class').Class;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, Blog_add(blogName, 3)];
            case 1:
                blog = _b.sent();
                if (!blog) return [3 /*break*/, 2];
                res.status(400).render('error', { mes: '文章名称已存在！', error: Error });
                return [3 /*break*/, 8];
            case 2:
                blogDate = new Date();
                fin_class = [];
                if (typeof blogClass == 'string')
                    ...
                    fin_class = blogClass;
                return [4 /*yield*/, Blog_add({ 'blogName': blogName, 'blogAuthor': blogAuthor, 'blogDate': blogDate, 'blogClass': fin_class.join(','), 'blogContent': blogContent }, 1)];
            case 3:
                _b.sent();
                k = 0;
                _b.label = 4;
            case 4:
                ...
                return [4 /*yield*/, add_classtable({ 'className': fin_class[k], 'classBlog': blogName }, 1)];
            case 5:
                _b.sent();
                _b.label = 6;
            case 6:
