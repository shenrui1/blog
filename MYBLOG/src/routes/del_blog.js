...
var Blog_del = require('../model/blog').Blog;
var del_classtable = require('../model/class').Class;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Blog_del(blogName, 3)];
            case 1:
                blog = _a.sent();
                if (!blog) return [3 /*break*/, 4];
                return [4 /*yield*/, del_classtable(blogName, 2)];
            case 2:
                _a.sent();
                return [4 /*yield*/, Blog_del(blogName, 2)];
            case 3:
                _a.sent();
                res.redirect('/admin');
                return [3 /*break*/, 5];
