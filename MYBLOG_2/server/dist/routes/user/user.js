...
var _this = this;
module.exports = function (req, res, _next) { return __awaiter(_this, void 0, void 0, function () {
    var blog, i, getblog, j, con_str;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, require('../user').Blog_blog('', 4)];
            case 1:
                blog = _a.sent();
                ...
                for (j = 0; j < blog.length; j++) {
                    ...
                    getblog += '<h3><form action="/user/blogtext_post" method="post"><input type="submit" name="blogName" value="' + blog[j].blogName + '"></form></h3>';
