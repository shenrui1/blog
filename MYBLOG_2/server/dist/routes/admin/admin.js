// import {User_user, Blog_admin} from '../admin';
...
module.exports = function (req, res, _next) { return __awaiter(_this, void 0, void 0, function () {
    var user, aa, geta, i, blog, getb, j;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, require('../admin').User_user('', 4)];
            case 1:
                user = _a.sent();
                aa = ['普通用户', '管理员'];
                geta = '';
                ...
                return [4 /*yield*/, require('../admin').Blog_admin('', 4)];
            case 2:
                blog = _a.sent();
                getb = '';
