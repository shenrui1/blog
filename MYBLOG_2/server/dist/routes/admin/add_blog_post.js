    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, require('../admin').Blog_admin(blogName, 3)];
            case 1:
                blog = _b.sent();
            ...
            case 2:
                ...
                if (typeof blogClass == 'string')
                    ...
                    fin_class = blogClass;
                return [4 /*yield*/, require('../admin').Blog_admin({ 'blogName': blogName, 'blogAuthor': blogAuthor, 'blogDate': blogDate, 'blogClass': fin_class.join(','), 'blogContent': blogContent }, 1)];
            case 3:
                _b.sent();
                k = 0;
                _b.label = 4;
            case 4:
                ...
                return [4 /*yield*/, require('../admin').class_table({ 'className': fin_class[k], 'classBlog': blogName }, 1)];
            case 5:
                _b.sent();
                _b.label = 6;
            case 6:
